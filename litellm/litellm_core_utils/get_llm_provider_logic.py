...
def _get_openai_compatible_provider_info(
    ...
    # publicai is now handled by JSON config (see litellm/llms/openai_like/providers.json)
        ...
        (
            api_base,  # rebind-ok: this chain resolves its inputs in place
            dynamic_api_key,  # rebind-ok: this chain resolves its inputs in place
        ) = litellm.EdenAIChatConfig()._get_openai_compatible_provider_info(api_base, api_key)
